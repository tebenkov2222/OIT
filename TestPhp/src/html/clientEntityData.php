					...
					<div class="form-group">
	            		...
	            		<?php 
					  		if($_GET['errorType'] == "name"){
					  			echo '<b class="errorForm">Имя неверно введен</b><br>';
					  		}
					  	 ?>
	            	</div>
					<div class="form-group">
	            		...
	            		<input class="form-control" type="text" name="inn" pattern="^\d{10}$|^\d{12}$" value="<?php echo $_SESSION['inn']; ?>" required>
	            		<?php 
					  		if($_GET['errorType'] == "inn"){
					  			echo '<b class="errorForm">ИНН неверно введен</b><br>';
					  		}
					  	 ?>
	            	</div>
					<div class="form-group">
